                                    ...
                                    <table class="table w-full table-auto datatable-table" id="dataTableTwo">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="lg:w-1/6 md:w-1/6 sm:w-1/6 xs:w-1/6">Phone</th>
                                                <th class="lg:w-1/6 md:w-1/6 sm:w-1/6 xs:w-1/6">Company Name</th>
                                                <th class="lg:w-1/6 md:w-1/6 sm:w-1/6 xs:w-1/6">Status</th>
                                                <th class="lg:w-1/6 md:w-1/6 sm:w-1/6 xs:w-1/6">Address</th>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($suppliers as $sup)
                                                <tr>
                                                    <td class="lg:w-1/6 md:w-1/6 sm:w-1/6 xs:w-1/6">{{ $sup->name }}</td>
                                                    <td class="lg:w-1/6 md:w-1/6 sm:w-1/6 xs:w-1/6">{{ $sup->phone }}</td>
                                                    <td class="lg:w-1/6 md:w-1/6 sm:w-1/6 xs:w-1/6">{{ $sup->company_name }}
                                                    </td>
                                                    <td class="lg:w-1/6 md:w-1/6 sm:w-1/6 xs:w-1/6">
                                                        <label class="relative inline-flex items-center cursor-pointer">
                                                            <input type="checkbox" data-id="{{ $sup->id }}"
                                                                name="status" class="js-switch"
                                                                {{ $sup->status == 1 ? 'checked' : '' }} value=""
                                                                class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600">
                                                        </label>
                                                    </td>
                                                    <td class="lg:w-1/6 md:w-1/6 sm:w-1/6 xs:w-1/6">{{ $sup->address }}</td>
                                                    <td class="lg:w-1/6 md:w-1/6 sm:w-1/6 xs:w-1/6">
