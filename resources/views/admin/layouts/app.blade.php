...
<head>
    ...
    <link href="{{ asset('assets/css/style.css') }}?v=85" rel="stylesheet" />
    <!-- Toggle Link -->
...
$watch('darkMode', value => localStorage.setItem('darkMode', JSON.stringify(value)))" class="dark text-bodydark bg-boxdark-2">
    <!-- ===== Preloader Start ===== -->
    <div x-show="loaded"
