@extends('admin.layouts.app', ['title' => 'Stock Details'])
@section('content')
    <!-- ===== Main Content Start ===== -->
    <main>
                    ...
                    <a href="{{ route('material-stock') }}">
                        <div
                            ...
                            <div class="mt-4 flex items-end justify-between">
                                <div>
                                    <h5 class="text-title-md font-bold text-black dark:text-white">
                                        Available : {{ $total_raw_material }}
                                    </h5>
                    ...
                    <a href="{{ route('item-stock') }}">
                        <div
                            ...
                            <div class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4">
                                <i class="fa fa-list-alt" aria-hidden="true" style="color: #f000c0;"></i>
